...
<div align="left">
      <p>   Ich bin <strong>Farhad</strong>, ein Student an der <strong>Aserbaidschanischen Technischen Universität</strong>.</p>
      <p>   Ich interessiere mich sehr für <strong>Frontend-Entwicklung</strong> und arbeite ständig daran, mich zu verbessern.</p>
      <p>🚀 Derzeit konzentriere ich mich auf <strong>TypeScript und React</strong>.</p>
      <p>🧠 Gleichzeitig verbessere ich meine <strong>Fähigkeiten in Algorithmen und Datenstrukturen</strong> mit C.</p>
      <p>Lass uns vernetzen und gemeinsam etwas Cooles bauen! 🚀✨</p>
</div>
